  ...
  inputFields={[
    ...
    },
    {
      props: {
        ...
        required: false,
        placeholder:
          "Make Your Event Accessible By Telling People What Accessibility Measures Are In Place",
      },
      description:
    ...
    },
    {
      ...
      description:
        "By ticking this box you aknowledge that one of the following applies; you are the event organiser, you have permission from the event organiser or you are submittig details for an event that are already publicly availible.",
    },
    {
      props: {
        name: "Contact Email",
