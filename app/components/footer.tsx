...
export default function Footer() {
  return (
    <footer className="bg-neutral-100 text-center dark:bg-neutral-700 lg:text-left">
      <div className="p-6 text-neutral-800 dark:text-neutral-100">
      ...
      <div className="bg-neutral-200 p-4 text-center text-neutral-700 dark:bg-neutral-600 dark:text-neutral-200">
