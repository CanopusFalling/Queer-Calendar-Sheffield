  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          property="og:url"
          content="https://queercalendarsheffield.co.uk/"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://queercalendarsheffield.co.uk/open-graph-banner.webp"
        />
        ...
        <meta
          ...
          content='A rainbow calendar icon with a heart shape in the centre of the icon and to the right of that the words \"Queer Calendar Sheffield\" in white, bold text each word on a new line all on a black background.'
        />
        ...
        <meta
          ...
          content="queercalendarsheffield.co.uk"
        />
        <meta
